...
export const getArticlesPageLimit = (state: StateSchema) => state.articlesPage?.limit || 27;
...
export const getArticlesLastScrolledIndex = (state: StateSchema) => state.articlesPage?.lastScrolledIndex;
